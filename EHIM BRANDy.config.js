...
export default {
  ...
  roles: {
    operator:            { label: 'Operator',            queue: ['scripting', 'needs_editing', 'needs_review', 'needs_revision', 'ugc_content_needed', 'ugc_content_review', 'ugc_content_approved', 'ugc_content_revision', 'ready_to_launch'] },
    cfo:                 { label: 'Chief Fun Officer',   queue: ['scripting', 'needs_editing', 'needs_review', 'needs_revision', 'ugc_content_needed', 'ugc_content_review', 'ugc_content_approved', 'ugc_content_revision', 'ready_to_launch'] },
    creative_strategist: { label: 'Creative Strategist', queue: ['scripting', 'needs_editing', 'needs_review', 'needs_revision', 'ugc_content_needed', 'ugc_content_review', 'ugc_content_approved', 'ugc_content_revision', 'ready_to_launch'] },
